...
void AFPS_CPPCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindTouch(IE_Pressed, this, &AFPS_CPPCharacter::TouchStarted);
	PlayerInputComponent->BindTouch(IE_Released, this, &AFPS_CPPCharacter::TouchStopped);
...
{
	// If FPS_CPP is added to a project via 'Add Feature' in the Unreal Editor the dependency on HeadMountedDisplay in FPS_CPP.Build.cs is not automatically propagated
...
void AFPS_CPPCharacter::TouchStarted(ETouchIndex::Type FingerIndex, FVector Location)
{
		Jump();
}

void AFPS_CPPCharacter::TouchStopped(ETouchIndex::Type FingerIndex, FVector Location)
{
		StopJumping();
}
