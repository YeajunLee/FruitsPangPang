...
void UGoldIconWidget::NativePreConstruct()
{
	bTickActive = false;
}

void UGoldIconWidget::NativeTick(const FGeometry& Geometry, float DeltaSeconds)
{
...
FVector2D UGoldIconWidget::FindCoord(float radius, float degree)
{
